    ...
    submit = () => {
        ...
        this.service
            ...
            .then(response => {
                ...
                messages.mensagemSucesso('Lançamento Realizado com Sucesso!');
            })
            .catch(error => {
            ...
            <Card title={this.state.atualizando ? 'Atualização de Lançamento' : 'Cadastro de Lançamentos'}>
                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <button onClick={() => this.props.navigate('/consulta-lancamentos')} 
...
// Componente wrapper para injetar navigate e params
const CadastroLancamentosWrapper = (props) => {
    const navigate = useNavigate();
    const params = useParams();
    console.log("Wrapper Params: ", params);
    return <CadastroLancamentos navigate={navigate} params={params} {...props} />;
};

export default CadastroLancamentosWrapper;
